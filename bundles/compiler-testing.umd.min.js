 ...
 * License: MIT
 */
!function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?factory(exports,require("@angular/compiler")):"function"==typeof define&&define.amd?define("@angular/compiler/testing",["exports","@angular/compiler"],factory):factory((global.ng=global.ng||{},global.ng.compiler=global.ng.compiler||{},global.ng.compiler.testing={}),global.ng.compiler)}(this,function(exports,_angular_compiler){"use strict";var extendStatics=function(d,b){return(extendStatics=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(d,b){d.__proto__=b}||function(d,b){for(var p in b)b.hasOwnProperty(p)&&(d[p]=b[p])})(d,b)};function __extends(d,b){function __(){this.constructor=d}extendStatics(d,b),d.prototype=null===b?Object.create(b):(__.prototype=b.prototype,new __)}
/**
 * @license Angular v7.0.0-beta.4-a2418a9037
 * (c) 2010-2018 Google, Inc. https://angular.io/
 * License: MIT
 ...
 */var MockResourceLoader=function(_super){function MockResourceLoader(){var _this=null!==_super&&_super.apply(this,arguments)||this;return _this._expectations=[],_this._definitions=new Map,_this._requests=[],_this}return __extends(MockResourceLoader,_super),MockResourceLoader.prototype.get=function(url){var request=new _PendingRequest(url);return this._requests.push(request),request.getPromise()},MockResourceLoader.prototype.hasPendingRequests=function(){return!!this._requests.length},MockResourceLoader.prototype.expect=function(url,response){var expectation=new _Expectation(url,response);this._expectations.push(expectation)},MockResourceLoader.prototype.when=function(url,response){this._definitions.set(url,response)},MockResourceLoader.prototype.flush=function(){if(0===this._requests.length)throw new Error("No pending requests to flush");do{this._processRequest(this._requests.shift())}while(this._requests.length>0);this.verifyNoOutstandingExpectations()},MockResourceLoader.prototype.verifyNoOutstandingExpectations=function(){if(0!==this._expectations.length){for(var urls=[],i=0;i<this._expectations.length;i++){var expectation=this._expectations[i];urls.push(expectation.url)}throw new Error("Unsatisfied requests: "+urls.join(", "))}},MockResourceLoader.prototype._processRequest=function(request){var list,el,index,url=request.url;if(this._expectations.length>0){var expectation=this._expectations[0];if(expectation.url==url)return list=this._expectations,el=expectation,(index=list.indexOf(el))>-1&&list.splice(index,1),void request.complete(expectation.response)}if(!this._definitions.has(url))throw new Error("Unexpected request "+url);var response=this._definitions.get(url);request.complete(null==response?null:response)},MockResourceLoader}(_angular_compiler.ResourceLoader),_PendingRequest=function(){function _PendingRequest(url){var _this=this;this.url=url,this.promise=new Promise(function(res,rej){_this.resolve=res,_this.reject=rej})}return _PendingRequest.prototype.complete=function(response){null==response?this.reject("Failed to load "+this.url):this.resolve(response)},_PendingRequest.prototype.getPromise=function(){return this.promise},_PendingRequest}(),_Expectation=function(){return function(url,response){this.url=url,this.response=response}}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */exports.MockResourceLoader=MockResourceLoader,exports.MockSchemaRegistry=MockSchemaRegistry,exports.MockDirectiveResolver=MockDirectiveResolver,exports.MockNgModuleResolver=MockNgModuleResolver,exports.MockPipeResolver=MockPipeResolver,Object.defineProperty(exports,"__esModule",{value:!0})});