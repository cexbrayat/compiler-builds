 ...
 */
/// <amd-module name="@angular/compiler/src/render3/view/i18n/util" />
 ...
 */
export declare function getTranslationDeclStmts(variable: o.ReadVarExpr, message: string, meta: I18nMeta, params?: {
    [name: string]: o.Expression;
